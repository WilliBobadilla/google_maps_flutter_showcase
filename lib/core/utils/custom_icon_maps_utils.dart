...
class MarkerGenerator {
  ...
  MarkerGenerator(this._markerSize) {
    ...
    _outlineCircleWidth = _circleOffset! - (_circleStrokeWidth! / 2.5);
  ...
  Future<BitmapDescriptor> createBitmapDescriptorWithCircleFromAsset(
    String iconDataPath,
    Color iconColor,
    Color circleColor,
    ...
    _paintIconPath(canvas, iconDataPath);
  ...
  /// Paints the icon
  void _paintIconPath(Canvas canvas, String iconDataPath) async {
    ByteData bd = await rootBundle.load(iconDataPath);
  ...
  /// Paints the icon
  void _paintIconData(Canvas canvas, Color color, IconData iconData) {
